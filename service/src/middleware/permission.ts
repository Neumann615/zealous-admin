...
export const ROUTE_PERMISSIONS: RoutePermissionRule[] = [
  ...
  { method: 'GET', path: '/form/categories/tree', permission: ['form:form:list'] },
  { method: 'POST', path: '/form/categories/create', permission: ['form:form:edit'] },
  { method: 'POST', path: '/form/categories/:id/update', permission: ['form:form:edit'] },
  { method: 'POST', path: '/form/categories/:id/status', permission: ['form:form:edit'] },
  { method: 'POST', path: '/form/categories/:id/delete', permission: ['form:form:edit'] },
